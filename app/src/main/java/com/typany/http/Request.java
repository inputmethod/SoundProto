...
import com.typany.http.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    protected Response.LoadingListener mLoadingListener;
    ...
    /**
     * @return this request's {@link com.typany.http.Response.ErrorListener}.
     */
